...
echo "$($PSQL "select teams.name from games inner join teams on games.winner_id=teams.team_id OR games.opponent_id=teams.team_id where games.year=2014 and round='Eighth-Final' ORDER BY teams.name"  )"
